...
import { Sparkles, Play, Pause, Zap, Music, Disc, Wallet } from "lucide-react";
  ...
  return (
    <main className="min-h-screen flex flex-col items-center p-4 md:p-10 text-white selection:bg-pink-500 selection:text-black">
      ...
      <nav className="w-full max-w-3xl flex justify-between items-center mb-12 border-b border-white/10 pb-4">
        ...
        <button className="flex items-center gap-2 bg-white/5 hover:bg-white/10 border border-white/20 px-4 py-2 text-xs font-bold uppercase tracking-widest transition-all">
